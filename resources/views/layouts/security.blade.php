    ...
    <ul class="navbar-nav ml-auto">
         ...
         <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" style="width: 300px;">
              ...
              @endforeach
              <div class="dropdown-divider"></div>
              <a href="{{ route('general.notification.viewer',1) }}" class="dropdown-item dropdown-footer">See All Notifications</a>
              </div>
              @else
      ...
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <img src="{{ url($SECURITY_OBJECT['DP_URL']) }}" alt="Profile Picture"  width="30" height="30" class="rounded-circle">
        </a>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
            <img src="{{ url($SECURITY_OBJECT['DP_URL']) }}" class="img-circle elevation-2" alt="Profile Image">
        </div>
          <div class="info">
            <a href="#" class="d-block">{{$SECURITY_OBJECT['NAME'] }}</a>
          </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{route('security.dashboard')}}" class="nav-link">
              <i class="nav-icon fas fa-tachometer-alt"></i>
              <p>Dashboard</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="{{route('security.profile')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{route('security.visitor.validate')}}" class="nav-link">
              <i class="fas fa-user-check nav-icon"></i>
              <p>Visitors Validation</p>
            </a>
          </li>
        
          <li class="nav-item">
            <a href="{{route('security.visitor.register')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{route('security.visitor.log')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{route('general.notification.viewer',1)}}" class="nav-link">
